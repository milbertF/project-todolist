      ...
      <div className="modalCon">
        ...
        <div className="part">
          ...
          <div className="inputPart">
            <input type="text" name="" id="inputTask" required />
          </div>
        </div>
        <div className="part">
          <label htmlFor="inputTime">Time</label>
          <div className="inputPart">
            <input type="text" name="" id="inputTime" required />
          </div>
        </div>
        <div className="partWrap">
          <div className="part">
            ...
            <div className="inputPart">
              <select name="" id="selectPriority" required>
          ...
          <div className="part">
            ...
            <div className="inputPart">
              <select name="" id="selectCategory" required>
          ...
          <div className="cardCon">
            ...
            <div className="cards">
              <div className="nameDate">
                <h3>Arpbayot kjbs sc askc as cas cjks ckcas </h3>
                <time dateTime="03/05/2025">03/05/2025</time>
              </div>
